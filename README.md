This is ocufuzz, a vision-only agentic fuzzer for frontend QA. 

First, it explores the website -> ideates test sequences  ->  executes those sequences -> evaluates every step of the execution for bugs or anomomalities -> reports results of all test sequences.
